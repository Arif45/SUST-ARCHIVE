...
<div class="container">
	...
	<form method="get" action="takecourse">
		<select name="session">
	...
	<div class="panel">
        ...
        <tr>
            ...
            <td> <a href="${pageContext.request.contextPath}/addtocourse?courseCode=${courses.getCourseCode()}&courseSession=${courses.getSession()}"><c:out value="${courses.getCourseTitle()}"/></td>
