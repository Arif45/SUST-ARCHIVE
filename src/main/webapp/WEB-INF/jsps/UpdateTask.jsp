...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <% 
	...
	%>
  <form action="${pageContext.request.contextPath}/edittask" method="post" onsubmit=" return validation();">
	
	
	
    <div class="form-group">
      <label for="taskTitle">Task Title</label>
      <input type="text" class="form-control" id="taskTitle" name="taskTitle" value="${taskTitle}">
    </div>
    <div class="form-group">
      <label for="taskDesc">Task Description</label>
      <input type="text" class="form-control" id="taskDesc" name="taskDesc" value="${taskDesc}">
    </div>
    <div class="form-group">
      <label for="deadline">DeadLineDeadLine(Please follow this format YYYY-MM-DD hh:mm:ss)</label>
      <input type="text" class="form-control" id="deadline" name="deadline" value="${taskDeadline}">
    </div>
