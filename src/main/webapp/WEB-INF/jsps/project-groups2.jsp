...
<script
	...
	type="text/javascript"></script>
<!--  <script -->
<%-- 	src="<c:url value="/resources/javascript/project-groups-static2.js" />" --%>
<!-- 	type="text/javascript"></script> -->
...
<body>
	...
	<div class="container">
		...
		<a style="float: left"
			href="${pageContext.request.contextPath}/gototasks?course_id=<%=courseId%>">Previous
			Page</a>
			...
			<div class="row">
				...
				<div class="col-xs-4 rowAddButton">
					...
					<c:choose>
						...
						<c:otherwise>
							<button id="button_add_project" class="btn btn-success" onclick="goToAddProjectForm(${task_id})">
								<i class="glyphicon glyphicon-plus-sign"></i> Add Project
							</button>
						</c:otherwise>
					</c:choose>
